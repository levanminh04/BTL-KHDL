...
# Chuyển đổi sang đơn vị triệu CAD
mu0_million = mu0 / 1e6
...
# Giả thuyết H1: μ > μ0 (so với mức trung bình 2018–2019)
if sample_mean > mu0:
...
# --- In kết quả ---
print("=== Kết quả kiểm định giả thuyết một mẫu ===")
print(f"Cỡ mẫu (n): {n}")
...
# Vẽ đường μ0 (2018–2019) và mean (2020–2021)
